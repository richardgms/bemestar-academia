        ...
        <AnimatePresence>
            {isVisible && (
                <motion.a
                    ...
                    className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#22D3EE] rounded-full flex items-center justify-center text-white shadow-lg shadow-cyan-900/20 hover:bg-[#06B6D4] transition-colors"
